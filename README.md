...
1. **1. Модель сети** — сформировать DAG, таблица дуг, визуализация и подсветка произвольного маршрута  
2. **2. Оптимумы по KPI** — три оптимальных маршрута (Дейкстра по *cost* / *time* / *risk*) и подсветка выбранного  
3. **3. Якорь и баланс** — якорный KPI, допуск 10–15%, сбалансированный маршрут и рейтинг всех маршрутов  
4. **4. Оценка отклонений** — сравнение с оптимумами, пороги 20% / 25%, рекомендации  
...
| Pyvis не отображается | На вкладке **1. Модель сети** выберите **Plotly** или **Matplotlib** |
