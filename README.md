...
1. **Граф и визуализация** — сформировать DAG, выбрать тип рендера, настроить отображение и при необходимости подсветить маршрут  
2. **Маршруты** — выполнить оптимизацию по якорному KPI и допуску  
3. **KPI** — проанализировать отклонения и рекомендации  
...
| Pyvis не отображается | На вкладке **Граф и визуализация** выберите **Plotly** или **Matplotlib** |
