...
1. **① Модель сети** — генерация DAG, сводка, таблица дуг, схема (Graphviz / Pyvis)  
2. **② Оптимумы по KPI** — три маршрута Дейкстры по *cost* / *time* / *risk*  
3. **③ Итоговый маршрут** — якорный KPI, допуск 10–15%, один итоговый маршрут  
4. **④ Оценка KPI** — сравнение с оптимумами, пороги 20% / 25%  
...
| Pyvis не отображается | На этапе **① Модель сети** выберите **Graphviz** |
